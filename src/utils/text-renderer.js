 ...
 * Borrowed from typeface-0.14.js (http://typeface.neocracy.org)
 */
...
var Text = {
  ...
  /**
   * Render a single glyph to the canvas
   * @param {CanvasRenderingContext2D} ctx - Canvas context
   * @param {Object} face - Font face object
